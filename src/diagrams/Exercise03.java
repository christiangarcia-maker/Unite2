...
public class Exercise03 {
	...
	public static void main(String[] args) {
		...
		// Declaración de variable donde se almacena el primer numero dado por el usuario.
		int primerNumero;
		
		// Declaración de variable donde se almacena el primer numero dado por el usuario.
		int segundoNumero;
		
		// Declaración donde se guardará el valor de la suma de los dos valores.
		int suma;

		// Declaración donde se guardará el valor de la resta de los dos valores.
		int resta;
		
		// Declaración donde se guardará el valor de la multiplicación de los dos valores.
		double multiplicacion;
		
		// Declaración donde se guardará el valor de la división de los dos valores.
		double division;
		...
		// Imprime en pantalla el resultado de la suma, resta y multiplicación de ambos valores.
		...
		// Se mira si el el valor del segundo número es 0, en el caso de que lo sea imprime la cadena, si no, imprime el resultado.
